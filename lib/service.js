...
var service = function (requestProcessors) {
    ...
    //app.use('/js', express.static(path.join(__dirname, 'static/assets/js'))); //  "public" off of current is root
    app.use('/js', express.static(path.join(__dirname + '/static/assets')));
